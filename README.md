...
Na instalação do Git, na tela **Configuring the terminal emulator to use with Git Bash**, selecione a opção **Use Windows' default console window**. As demais opções podem ficar como está.
